...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Hero Section - Solo imagen de portada desde Firestore */}
      <section className="relative h-[85vh] min-h-[600px] overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white px-4">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"><Button variant="default" size="lg" className="text-lg px-8 rounded-full">Reservar <ArrowRight className="ml-2 h-5 w-5" /></Button></a>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 md:py-28 relative overflow-hidden bg-gradient-to-r from-blue-600 to-red-600"><div className="relative z-10 container mx-auto px-4 text-center text-white"><h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-4">¿Listo para disfrutar?</h2><p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-white/90">Reserva tu mesa o pide a domicilio</p><a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"><Button variant="default" size="lg" className="bg-white text-gray-900 hover:bg-gray-100 text-lg px-8 rounded-full shadow-xl">Reservar ahora <ArrowRight className="ml-2 h-5 w-5" /></Button></a></div></section>
    </div>
  )
}