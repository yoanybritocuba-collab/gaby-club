...
const translations: Record<string, Record<Language, string>> = {
  ...
  'home.favoritesDescription': { es: 'Los favoritos de nuestros comensales', en: 'Our diners favorites', fr: 'Les favoris de nos convives', de: 'Die Favoriten unserer Gäste', ru: 'Любимые блюда наших гостей' },
  ...
  'menu.noProducts': { es: 'No hay productos disponibles', en: 'No products available', fr: 'Aucun produit disponible', de: 'Keine Produkte verfügbar', ru: 'Нет доступных productos' },
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  const setLanguage = (lang: Language) => {
    ...
    // Recargar la página para actualizar todos los datos de Firestore
